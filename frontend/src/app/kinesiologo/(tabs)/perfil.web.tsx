            ...
            <View style={s.colLeft}>
              ...
              <View style={s.avatarCard}>
                <View style={s.avatarCircle}>
                  <Text style={s.avatarText}>DR</Text>
                </View>
                <Text style={s.profileName}>Dr. Rodríguez</Text>
                <Text style={s.profileEmail}>kinesiologo@kinova.com</Text>
                ...
                <View style={s.infoGrid}>
                  {PERFIL_INFO.map((item) => (
                    <View key={item.label} style={s.infoRow}>
                      ...
                      <TouchableOpacity style={s.infoEdit} activeOpacity={0.7}>
                        <Ionicons name="pencil-outline" size={14} color={C.gray400} />
                      </TouchableOpacity>
                    </View>
                  ))}
                </View>
...
const s = StyleSheet.create({
  ...
  profileName: { color: C.navy, fontSize: 18, fontWeight: '700', marginBottom: 4 },
  profileEmail: { color: C.gray400, fontSize: 13, marginBottom: 10 },
  roleBadge: {
  ...
  editBtnText: { color: C.turquoise, fontSize: 14, fontWeight: '600' },
  logoutBtn: {
